  ...
  return (
    <section className="relative overflow-x-hidden pb-[90px] pt-[70px]">
      <div className="container mx-auto">
        ...
        {/* Right hand */}
        <div className="-rotate-4 absolute -right-[4px] 2xl:-right-[40px] -top-[8px] -z-10 h-[165px] w-[200px] opacity-60 sm:top-0 sm:h-[250px] sm:w-[300px] md:-top-[15px] md:h-[340px] md:w-[390px] lg:h-[400px] lg:w-[500px] xl:h-[450px] xl:w-[620px] 2xl:-top-[50px] 2xl:h-[600px] 2xl:w-[750px]">
